...
lib.ssMetadata = [
		{name:"index_atlas_P_", frames: [[0,228,216,190],[0,0,185,226],[405,0,98,134],[436,136,70,70],[218,192,216,190],[187,0,216,190]]}
];
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{stop_0:93,start_0:106,stop_1:337,start_1:353,stop_2:718,start_2:730,stop_3:968,start_3:982,stop_4:1192,start_4:1206});
	...
	this.frame_1387 = function() {
		this.stop();
	}

	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(93).call(this.frame_93).wait(244).call(this.frame_337).wait(381).call(this.frame_718).wait(250).call(this.frame_968).wait(224).call(this.frame_1192).wait(195).call(this.frame_1387).wait(1));

	// click
	this.btn_4 = new lib.BtnPlayVideo();
	this.btn_4.parent = this;
	this.btn_4.setTransform(1236.1,14,0.051,0.087,0,0,0,199.5,115);

	this.btn_3 = new lib.BtnPlayVideo();
	this.btn_3.parent = this;
	this.btn_3.setTransform(1022.5,403.4,0.759,0.87,0,0,0,198.1,115);

	this.btn_2 = new lib.BtnPlayVideo();
	this.btn_2.parent = this;
	this.btn_2.setTransform(650.7,255.2,1.114,1.13,0,0,0,198.2,115.1);

	this.btn_1 = new lib.BtnPlayVideo();
	this.btn_1.parent = this;
	this.btn_1.setTransform(511.5,480.4,0.759,0.87,0,0,0,198.1,115);

	this.btn_0 = new lib.BtnPlayVideo();
	this.btn_0.parent = this;
	this.btn_0.setTransform(239.5,345.5,0.759,0.87,0,0,0,198.1,115);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.btn_0},{t:this.btn_1},{t:this.btn_2},{t:this.btn_3},{t:this.btn_4}]},88).to({state:[]},12).wait(1288));
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.btnNext.setTransform(1152,681,1,1,0,0,0,24,30);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btnPlay},{t:this.btnStop},{t:this.txtDuration},{t:this.txtCurrent},{t:this.progressBar},{t:this.text},{t:this.btnBack},{t:this.btnNext}]}).wait(1));
