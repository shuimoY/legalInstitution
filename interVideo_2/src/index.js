...
lib.ssMetadata = [
		{name:"index_atlas_P_", frames: [[0,192,216,190],[218,328,111,111],[318,192,111,111],[218,192,98,134],[331,305,70,70],[218,0,216,190],[0,0,216,190]]}
];
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{stop_0:41,start_0:77,stop_1:426,start_1:434,stop_2:703,start_2:707});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(41).call(this.frame_41).wait(870).call(this.frame_911).wait(1));

	// click
	this.btn_2 = new lib.BtnPlayVideo();
	this.btn_2.parent = this;
	this.btn_2.setTransform(1025,279.1,0.886,1.522,0,0,0,198.1,115.2);

	this.btn_1 = new lib.BtnPlayVideo();
	this.btn_1.parent = this;
	this.btn_1.setTransform(634,279.1,0.886,1.522,0,0,0,198.1,115.2);

	this.btn_0 = new lib.BtnPlayVideo();
	this.btn_0.parent = this;
	this.btn_0.setTransform(238,282.1,0.886,1.522,0,0,0,198.1,115.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.btn_0},{t:this.btn_1},{t:this.btn_2}]},41).to({state:[]},1).wait(870));
