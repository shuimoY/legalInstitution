...
lib.ssMetadata = [
		{name:"index_atlas_P_", frames: [[187,0,216,190],[0,0,185,226],[405,0,98,134],[436,136,70,70],[218,192,216,190],[0,228,216,190]]}
];
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{stop_0:152,start_0:165,stop_1:290,start_1:300,stop_2:406,start_2:417,stop_3:607,start_3:609,stop_4:672,start_4:691});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(152).call(this.frame_152).wait(138).call(this.frame_290).wait(116).call(this.frame_406).wait(266).call(this.frame_672).wait(187));

	// click
	this.btn_5 = new lib.BtnPlayVideo();
	this.btn_5.parent = this;
	this.btn_5.setTransform(1099,-86,0.003,0.004,0,0,0,218.5,115);

	this.btn_4 = new lib.BtnPlayVideo();
	this.btn_4.parent = this;
	this.btn_4.setTransform(1032,-73,0.003,0.004,0,0,0,218.5,115);

	this.btn_2 = new lib.BtnPlayVideo();
	this.btn_2.parent = this;
	this.btn_2.setTransform(596.9,273.6,1.013,0.87,0,0,0,198.3,115.4);

	this.btn_3 = new lib.BtnPlayVideo();
	this.btn_3.parent = this;
	this.btn_3.setTransform(1072.7,410.6,0.759,0.87,0,0,0,198.3,115.4);

	this.btn_1 = new lib.BtnPlayVideo();
	this.btn_1.parent = this;
	this.btn_1.setTransform(948.6,236.5,0.759,0.652,0,0,0,198.3,115.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.btn_1},{t:this.btn_3},{t:this.btn_2},{t:this.btn_4},{t:this.btn_5}]},148).to({state:[]},13).wait(698));
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.btnNext_1 = new lib.BtnNext();
	this.btnNext_1.parent = this;
	this.btnNext_1.setTransform(1152,680,1,1,0,0,0,24,30);
	this.btnNext_1.alpha = 0.602;
	this.btnNext_1.visible = false;
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.caption},{t:this.btnNext_1},{t:this.btnNext}]}).wait(1));
